...
plot stopAt =  if direction>0 then long else short;
def stopPct =  if direction>0 then (close - long)/close * 100 else na;
...
stopAt.assignValueColor(if stopPct < 0 then color.RED else 
