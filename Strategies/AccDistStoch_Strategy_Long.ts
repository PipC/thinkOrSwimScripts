...
AddLabel(yes, "EXTREME", Color.CYAN);
...
#def ExitShort1 = CCI <= -195 or AccDist <= .5 or AccDist crosses above ad_over_bought;


#Order Entry
AddOrder(OrderType.BUY_TO_OPEN, signalup, tradesize=100, tickcolor = Color.GREEN, arrowcolor = Color.GREEN, name = "BUY");
AddOrder(OrderType.SELL_TO_CLOSE, signaldown, tradesize=100, tickcolor = Color.GREEN, arrowcolor = Color.GREEN, name = "SELL");
...
#AddOrder(OrderType.SELL_TO_OPEN, Short1, tradesize=1, tickcolor = Color.RED, arrowcolor = Color.RED, name = "SHORT1");
#AddOrder(OrderType.BUY_TO_CLOSE, ExitShort1,  tradesize=1,  tickcolor = Color.RED, arrowcolor = Color.RED, name = "EXITSHORT1");
