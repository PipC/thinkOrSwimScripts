...
AddLabel(yes, "Shares to buy: " + Round(5000 / close, 0), Color.BLUE);
def tradesize = 12000 / close;
AddOrder(OrderType.BUY_TO_OPEN, condition = buyTrigger, price = close[-1], tradeSize = tradesize, tickcolor = Color.CYAN, arrowcolor = Color.BLUE, "buy") ; # , "buy"

AddOrder(OrderType.SELL_TO_CLOSE, condition = sellTrigger, price = close[-1], tradeSize = tradesize, tickcolor = Color.DARK_ORANGE, arrowcolor = Color.RED, "sell") ;  #  , "sell"
