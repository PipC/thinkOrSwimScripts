...
AddChartBubble(distributionDay and newDistributionCycle and totalNdDays, high,
...
AddChartBubble(stallDay AND lastDays and totalNdDays, high,
...
addLabel(totalNdDays and totalDdays != totalNdDays, "AllDdays =" + concat("", totalDdays), Color.GRAY);
addLabel(totalNdDays, "NewDdays =" + concat("",totalNdDays ),
...
AddChartBubble(RallyDay1, low, "R1", color.LIGHT_GREEN, 0);