...
MajorSwHigh.setpaintingStrategy(paintingStrategy.DASHES);
MajorSwHigh.setLineWeight(5);
MajorSwHigh.setdefaultColor(Color.WHITE);
plot MajorSwLow = pValL;
MajorSwLow.setpaintingStrategy(paintingStrategy.DASHES);
MajorSwLow.setLineWeight(5);
MajorSwLow.setdefaultColor(Color.WHITE);
