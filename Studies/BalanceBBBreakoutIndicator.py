...
MACDBB_Upper.SetDefaultColor(Color.LIGHT_RED);
...
MACDBB_Lower.SetDefaultColor(Color.LIGHT_GREEN);
...
MACDBB_Midline.SetDefaultColor(Color.WHITE);
...
RSM_MACD_ZeroLine.SetDefaultColor(Color.ORANGE);
...
"Buy " + close, Color.LIGHT_GREEN, Curve.SHORT_DASH);
AddVerticalLine(ShowBullBearVerticalLines and BullBear_Sell and !BullBear_Sell[1], 
"Sell " + close, Color.LIGHT_RED, Curve.SHORT_DASH);
