...
#plot scan = ((STCWaveResult[8] < 0 and STCWaveResult > 0 and STCWave[8] <= over_sold ) 
#            or (STCWaveResult[8] < 0 and STCWaveResult > 0 and STCWave[8] <= over_sold ) 
#            or (STCWaveResult[5] < 0 and STCWaveResult > 0 and STCWave[5] <= over_sold ))
plot scan = (STCWaveResult[8] < 0 and STCWaveResult > 0 ) 
and MovingAverage(AverageType.Simple , STCWave, 10) < over_sold
and STCWave <= over_sold;
