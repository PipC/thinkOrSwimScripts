...
def volLastXDayAvg = Average( volume(period = agg), LastXPeriodAvgLength);
...
plot scan = MovingAverage(AverageType.SIMPLE, SellVolPercent, 3) < 30 
and MovingAverage(AverageType.SIMPLE, hv, 3) > (ma*0.85)
