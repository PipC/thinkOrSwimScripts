...
#def Add = if !added or added crosses above 0 then retrace else nan;

plot scan = (PivotConfirmed[1] or PivotConfirmed) 
#and close * 1.1 <= BuyToOpen
and ((close - SellToClose) / close[1]) < 0.15
and ((close - TrailingStop) / close[1]) < 0.10;
